...
def depositar(saldo, valor, extrato, /):
    if valor > 0:
        ...
        print("\n**** Depósito não realizado O valor informado é inválido. ****")
...
def criar_usuario(usuarios):
    cpf = input("Informe o CPF (apenas números, por favor): ")
...
def criar_conta(agencia, numero_conta, usuarios):
    ...
    print("\n**** Este usuário ainda não foi cadastrado. Impossível criar conta! ****")
